                    ...
                    <Modal show={show} onHide={handleClose}>
                        <Modal.Header closeButton>
                            <div className='title flex'>
                                <Modal.Title>Expenses - {props.title}</Modal.Title>
                        ...
                        <Form className="mx-3 mt-3">
                            <Form.Group className="mb-3">
                                {expenseForms && expenseForms.filter(item => item.user === props.title ).map(expense => (
                                    <div key={shortid.generate()} className='expense flex justify-between items-center mb-3'>
