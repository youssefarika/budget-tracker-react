        ...
        <div className= {CardColor}>
            <div className="py-3">
                ...
                <div className="buttons flex justify-between">
                    ...
                    <ViewExpens outline = {"hover:bg-blue-400 text-blue-700 font-semibold hover:text-white py-2 px-2 border border-blue-500 rounded"} text= {"View Expenses"} title ={props.title}/>
                </div>
            </div>
    </div>
    )
